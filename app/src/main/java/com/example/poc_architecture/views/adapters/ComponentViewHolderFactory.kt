...
class ComponentViewHolderFactory {
    ...
    companion object {
        fun getComponent(
            ...
            viewType: Int,
            viewMode: ViewMode,
            listenerUpdate: IListenerUpdate? = null,
            iCallbackShowMore: ICallbackShowMore? = null
        )
            ...
            return when (ViewType.idByNumber(viewType)) {
                ITEM_SEARCH -> {
                    ...
                    ItemSearchViewHolder(itemView, parent, viewMode, listenerUpdate, iCallbackShowMore)
                }
                ITEM_CAROUSEL -> {
